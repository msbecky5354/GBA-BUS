...
const App: React.FC = () => {
  ...
  const showNotice = (type: string) => {
    ...
    switch (type) {
      case 'about':
        title = '關於我們';
        content = <p><strong>「深中珠巴士懶人包」</strong> 是一個由中山美食地圖團隊發起的資訊整合工具。我們透過人手蒐集並校對數據，致力讓大家出行更便利。請大家多多支持我們的團隊！</p>;
        break;
      case 'contact':
        title = '聯絡我們';
        content = <p>如您發現資訊有誤，歡迎到 Facebook 群組聯絡我們：<a href="https://www.facebook.com/groups/998954119219884" target="_blank" rel="noreferrer" style={{ color: '#3b82f6', fontWeight: 'bold' }}>中山美食地圖群組</a></p>;
        break;
      case 'privacy':
        title = '隱私權政策';
        content = <p>本站為純資訊展示平台。所有的購票交易均在第三方官方平台上進行，本站不會接觸或收集您的任何個人付款資訊。</p>;
        break;
      case 'terms':
        title = '服務條款';
        content = <ul style={{ paddingLeft: '20px' }}><li>數據為人手輸入，雖致力準確但仍可能存在誤差。</li><li>購票前請務必點擊連結以營運商官方最新資訊為準。</li></ul>;
        break;
    }
